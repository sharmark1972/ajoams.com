          ...
          <div className="lg:col-span-1">
            <Link href="/" className="inline-block mb-6">
              <div className="flex items-center gap-3">
                <div className="p-2 rounded-md" style={{background: '#d4a000'}}>
                  <span className="font-bold text-xl tracking-wider text-white">AJ</span>
                </div>
                <div className="flex flex-col">
                  <span className="font-bold text-2xl text-white tracking-wide">AJOAMS</span>
                  <span className="text-[0.65rem] uppercase tracking-widest font-medium" style={{color: '#f4c430'}}>Medical Journal</span>
                </div>
              </div>
            </Link>
            <p className="text-sm leading-relaxed mb-6" style={{color: '#87d4e0'}}>
              Publishing rigorous, peer-reviewed research in advanced medical and surgical sciences globally.
            </p>
