...
export default function HomePage() {
  ...
  return (
    <>
      <DynamicSEO
        title="AJOAMS - American Journal of Advanced Medical and Surgical Sciences"
        description="Publishing rigorous, peer-reviewed research in advanced medical and surgical sciences for a global audience."
        keywords={['medical sciences', 'surgical research', 'research journal', 'academic publishing', 'AJOAMS', 'peer review']}
        ogImage="https://wjiis.com/og-image.jpg"
        canonicalUrl="https://wjiis.com"
      />
      <WebsiteSchema
        name="AJOAMS"
        url="https://ajoams.com"
        description="Publishing rigorous, peer-reviewed research in advanced medical and surgical sciences for a global audience."
        publisher="AJOAMS"
      />
      <OrganizationSchema
        name="AJOAMS"
        url="https://ajoams.com"
        logo="https://ajoams.com/ajoams-logo.svg"
        description="AJOAMS - American Journal of Advanced Medical and Surgical Sciences"
        contactPoint={{
          email: "editor@ajoams.com",
      ...
      <div className="min-h-screen font-sans">
        ...
        {/* Hero Section */}
        <section className="relative border-b border-slate-200" style={{background: 'linear-gradient(135deg, #1a3a4a 0%, #2c5a6a 100%)'}}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-8 space-y-6">
                <div className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold tracking-wide uppercase" style={{background: 'rgba(255,255,255,0.15)', color: '#87d4e0'}}>
                  ISSN: 3878-6817 (Online)
                </div>

                <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold leading-tight text-white">
                  American Journal of <br className="hidden md:block" />
                  <span style={{color: '#f4c430'}}>Advanced Medical and Surgical Sciences</span>
                </h1>

                <p className="text-xl max-w-2xl leading-relaxed" style={{color: '#f4c430'}}>
                  Publishing rigorous, peer-reviewed research that advances medical and surgical knowledge for a global audience.
                </p>
